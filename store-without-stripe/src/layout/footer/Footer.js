      ...
      <div className="mx-auto max-w-screen-2xl px-4 sm:px-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-7 xl:grid-cols-12 gap-5 sm:gap-9 lg:gap-11 xl:gap-7 py-10 lg:py-16 justify-between">
          {storeCustomizationSetting?.footer?.block1_status && (
            <div className="pb-3.5 sm:pb-0 col-span-1 md:col-span-2 lg:col-span-3" data-aos="fade-up" data-aos-offset="50">
        ...
        <div className="mx-auto max-w-screen-2xl px-4 sm:px-10 bg-gray-50 shadow-sm border border-gray-50 rounded-lg" data-aos="zoom-in" data-aos-offset="50">
