...
const OfferCard = () => {
  ...
  return (
    <div className="w-full group">
      <div className="bg-gray-50 h-full border-2 border-emerald-500 transition duration-150 ease-linear transform group-hover:border-emerald-400 rounded shadow">
